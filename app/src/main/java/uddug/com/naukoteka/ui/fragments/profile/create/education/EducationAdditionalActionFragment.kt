...
import uddug.com.naukoteka.databinding.FragmentEducationAdditionalActionBinding
import uddug.com.naukoteka.global.base.BaseFragment
import uddug.com.naukoteka.presentation.education.EducationAdditionalActionPresenter
import uddug.com.naukoteka.presentation.education.EducationAdditionalActionView
...
class EducationAdditionalActionFragment :
    BaseFragment(R.layout.fragment_education_additional_action),
    EducationAdditionalActionView {

    override val contentView: FragmentEducationAdditionalActionBinding by viewBinding(
        FragmentEducationAdditionalActionBinding::bind
    )

    @InjectPresenter
    lateinit var presenter: EducationAdditionalActionPresenter
    ...
    @ProvidePresenter
    fun providePresenter(): EducationAdditionalActionPresenter =
        getScope().getInstance(EducationAdditionalActionPresenter::class.java)

    override fun onCreateView(
        inflater: LayoutInflater,
        container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View = inflater.inflate(R.layout.fragment_education_additional_action, container, false)
