...
import uddug.com.naukoteka.databinding.FragmentProfileEditSettingsNotificationsBinding
...
class ProfileEditSettingsNotificationsFragment :
    BaseFragment(R.layout.fragment_profile_edit_settings_notifications),
    ProfileEditSettingsNotificationsView {

    override val contentView: FragmentProfileEditSettingsNotificationsBinding by viewBinding(
        FragmentProfileEditSettingsNotificationsBinding::bind
    )

    @InjectPresenter
    lateinit var presenter: ProfileEditSettingsNotificationsPresenter
    ...
    @ProvidePresenter
    fun providePresenter(): ProfileEditSettingsNotificationsPresenter {
        return getScope().getInstance(ProfileEditSettingsNotificationsPresenter::class.java)
    }
